                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?= isset($errores['nombre']) ? $errores['nombre'] : (!empty($producto->nombre) ? $producto->nombre : '') ?>" placeholder="Ingrese nombre...">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="descripcion" id="descripcion" value="<?= isset($errores['descripcion']) ? $errores['descripcion'] : (!empty($producto->descripcion) ? $producto->descripcion : '') ?>" class="form-control" placeholder="Ingrese Descripcion...">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="precio" id="precio" value="<?= isset($errores['precio']) ? $errores['precio'] : (!empty($producto->precio) ? $producto->precio : '') ?>" class="form-control" placeholder="Ingrese precio...">
                            ...
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="stock" id="stock" value="<?= isset($errores['stock']) ? $errores['stock'] : (!empty($producto->stock) ? $producto->stock : '') ?>" class="form-control" placeholder="Ingrese stock...">
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="codigo" id="codigo" value="<?= isset($errores['codigo']) ? $errores['codigo'] : (!empty($producto->codigo) ? $producto->codigo : '') ?>" class="form-control" placeholder="Ingrese codigo...">
                                        ...
                                        <select style="border: 3px;" name="categoria_id" id="select_categoria">
                                            ...
                                            <?php if (!empty($categorias)) : ?>
                                                <?php foreach ($categorias as $categoria) : ?>
                                                    <option value="<?= $categoria->id ?>" <?= isset($errores['categoria_id']) ? ($errores['categoria_id'] == $categoria->id ? 'selected' : '') : (!empty($producto->categoria_id) ? ($producto->categoria_id == $categoria->id ? 'selected' : '') : '') ?>><?= !empty($categoria->nombre) ? $categoria->nombre : 'Sin Información' ?></option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    </div>
